...
if __name__ == '__main__':
    # config_file = 'configs/edaps/syn2cs_uda_warm_dfthings_rcs_croppl_a999_edaps_s0.py'
    # expId = 7
    # machine_name = None
    ...
    if args.config is not None:
        ...
        panop_eval_folder = os.path.join(cfg['exp_root'], cfg['exp_sub'], unique_name, 'oass_eval')
        ...
        ## add
        # cfg_all_file = f"{child_cfg['work_dir']}/{child_cfg['name']}.json"
        # os.makedirs(os.path.dirname(cfg_all_file), exist_ok=True)
        # assert not os.path.isfile(cfg_all_file)
        # # with open(cfg_all_file, 'w') as of:
        # #     json.dump(cfg, of, indent=4)
        # cfg.dump(cfg_all_file)
        ##
    ...
    if args.exp is not None:
        if args.exp in [100, 101, 102]:
            ...
            # Experiments belongs to UnmaskFormer (M-Dec-TD) mdoels.
        ...
        for i, cfg in enumerate(cfgs):
            ...
            cfg['work_dir'] = os.path.join(cfg['exp_root'], cfg['exp_sub'], cfg['name'])
