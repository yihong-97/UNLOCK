...
apskitti_train_pipeline = [
                            ...
                            dict(type='Collect', keys=['img', 'gt_bboxes', 'gt_abboxes', 'gt_labels', 'gt_alabels', 'gt_masks', 'gt_amasks', 'gt_semantic_seg', 'gt_panoptic_only_thing_classes', 'max_inst_per_class']),
                        ]
