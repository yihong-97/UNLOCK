...
# cityscapes imports
from amodalscripts.helpers.annotation import Annotation
from amodalscripts.helpers.labels     import labels, name2label
...
def json2instanceImg(Json,outImg,encoding="ids"):
    annotation = Annotation()
    annotation.fromJsonText(Json)
