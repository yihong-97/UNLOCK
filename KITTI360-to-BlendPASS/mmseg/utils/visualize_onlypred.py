...
# def save_onlypredictions(dataset_name, image_filename, TrgSemPd, TrgPanPd, TrgAmoPanPd, outdir, debug, img_dir, ann_dir, resize_with_pad):
#     if dataset_name == 'cityscapes':
#         vis_W = 1024
#         vis_H = 512
#         fext = '.png'
...
#         vis_H = 200
#         fext = '.jpg'
#         filename1 = image_filename.split('/')[0] + '_' + image_filename.split('/')[1]
#         filename2 = image_filename + '.jpg'
#         output_filename = os.path.join(outdir, f'{filename1}.png')
#         input_filename = os.path.join(img_dir, filename2)
#     elif dataset_name == 'mapillary':
#         vis_W = 1024
...
#     rows, cols = 4, 1
#     fig, axs = plt.subplots(rows, cols, figsize=(24, 12), constrained_layout=True)
#     subplotimgV2(axs[0], vis_trg_img, 'TrgImg')
#     subplotimgV2(axs[1], prep_sem_for_vis(TrgSemPd, mode='PD', dataset_name=dataset_name, debug=debug,
#                                              blend_ratio=1.0, img=None), 'TrgSemPd')
#
#     subplotimgV2(axs[2], prep_pan_for_vis(TrgPanPd, dataset_name=dataset_name, debug=debug,
#                                              blend_ratio=1.0, img=None, runner_mode='val',
#                                              ax=axs[2], label_divisor=1000), 'TrgPanPd')
#     subplotimgV2(axs[3], prep_amopan_for_vis(TrgPanPd, TrgAmoPanPd, TrgPanPd.shape, dataset_name=dataset_name, debug=debug,
#                                              blend_ratio=1.0, img=None, runner_mode='val',
#                                              ax=axs[3], label_divisor=1000), 'TrgPanPd')
#     for ax in axs.flat:
#         ax.axis('off')
...
def save_onlypredictions(dataset_name, image_filename, TrgSemPd, TrginsPd, TrgPanPd, TrgAmoinsPd, TrgAmoPanPd, outdir, debug, img_dir, ann_dir, resize_with_pad):
    if dataset_name == 'cityscapes':
        vis_W = 1024
        vis_H = 512
        fext = '.png'
...
def save_all_onlypredictions(dataset_name, image_filename, TrgSemPd, TrgPanPd, TrgAmoPanPd, outdir, debug, img_dir, ann_dir, resize_with_pad):
    if dataset_name == 'cityscapes':
        vis_W = 1024
        vis_H = 512
        fext = '.png'
