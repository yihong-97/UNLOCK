...
from amodalscripts.helpers.annotation import (
    CsBbox3d,
    CsIgnore2d
)
from amodalscripts.helpers.box3dImageTransform import (
    Box3dImageTransform,
    Camera
)
from amodalscripts.evaluation.objectDetectionHelpers import (
...
def evaluate3dObjectDetection(
    ...
    if plot:
        ...
        from amodalscripts.evaluation.plot3dResults import plot_data
