...
def main():
    ...
    dataset_root = '/home/kit/anthropomatik/tp9819/Git/UnmaskFormer/data'
    for crowd_region_threshold in crowd_th_list:
        imgid = 0
        # label_path = 'Synthia/RAND_CITYSCAPES/GT/LABELS'
        label_path = '/pfs/work7/workspace/scratch/tp9819-ws/datasets/Synthia/RAND_CITYSCAPES/GT/LABELS'
