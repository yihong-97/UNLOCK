...
from mmdet.core import EvalHookUDA as EvalHook
...
def train_detector(model, dataset, cfg, distributed=False, validate=False, timestamp=None, meta=None,):
    ...
    if cfg.print_layer_wise_lr:
        ...
        for i in range(len(optimizer.param_groups)):
            ...
            if 'module.model.backbone' in layer_name:
                ...
                logger.info(f'layer_name: {layer_name}, layer_lr: {layer_lr}, layer_param1.shape: {layer_param1.shape},'
                            f' layer_param2.shape: {layer_param2.shape}, num_params: {layer_param2.numel()}')
    ...
    i = 0
    # for name, param in model.module.source_model.named_parameters():
    #     lr = param_group[i]['lr']
    ...
    if validate:
        ...
        # cfg.data.get('val_dataloader', {}) overrides val_dataloader_default_args
