...
# Cityscapes imports
from amodalscripts.helpers.csHelpers import *
from amodalscripts.evaluation.instances2dict import instances2dict
...
def getPrediction( groundTruthFile , args ):
    ...
    filePattern = "{}*.txt".format(groundTruthFile.split('/')[-1][:-len('_instanceTrainIds.png')])
