...
evaluation = dict(
    ...
    gt_dir=dataroot + "/Semantic/val_",
    gt_dir_insta=dataroot + "/Instance/val",
    gt_dir_panop=dataroot + "/BlendPASS/Panoptic/",
    ...
    visuals_pan_eval=True, # exp6 False
    visuals_all_eval=True, # exp6 False
    evalScale="2048x400", # exp6 None
    panop_eval_folder="UnmaskFormer_test_best/panoptic_eval",
    panop_eval_temp_folder="UnmaskFormer_test_best/panoptic_eval",
    debug=False,
    out_dir="UnmaskFormer_test_best/panoptic_eval/visuals"
)
...
name =  "UnmaskFormerSFDA_test_best"
exp = 6
...
checkpoint_file_path = "./pretrained_edaps/iter_4600.pth"
work_dir =  "UnmaskFormer_test_best"
git_rev =  ""
