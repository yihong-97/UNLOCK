...
def create_panop_eval_folders(panoptic_eval_root_folder, panop_eval_temp_folder=None):
    ...
    if panop_eval_temp_folder is not None:
        panop_eval_temp_folder_abs_path = os.path.join(panoptic_eval_root_folder, panop_eval_temp_folder)
    else:
        panop_eval_temp_folder_abs_path = panoptic_eval_root_folder
    ...
    panop_eval_folder_dict['amodal_instance'] = os.path.join(panop_eval_temp_folder_abs_path, 'amodal_instance')
    panop_eval_folder_dict['amodal_panoptic'] = os.path.join(panop_eval_temp_folder_abs_path, 'amodal_panoptic')
    ...
    panop_eval_folder_dict['visuals_semantic'] = os.path.join(panop_eval_folder_dict['visuals'], 'semantic')
    panop_eval_folder_dict['visuals_instance'] = os.path.join(panop_eval_folder_dict['visuals'], 'instance')
    panop_eval_folder_dict['visuals_amodal_instance'] = os.path.join(panop_eval_folder_dict['visuals'], 'amodal_instance')
    panop_eval_folder_dict['visuals_panoptic'] = os.path.join(panop_eval_folder_dict['visuals'], 'panoptic')
    panop_eval_folder_dict['visuals_amodal_panoptic'] = os.path.join(panop_eval_folder_dict['visuals'], 'amodal_panoptic')
    os.makedirs(panop_eval_folder_dict['semantic'],  exist_ok=True)
    os.makedirs(panop_eval_folder_dict['instance'],  exist_ok=True)
    os.makedirs(panop_eval_folder_dict['amodal_instance'],  exist_ok=True)
    os.makedirs(panop_eval_folder_dict['panoptic'],  exist_ok=True)
    os.makedirs(panop_eval_folder_dict['amodal_panoptic'],  exist_ok=True)
    os.makedirs(panop_eval_folder_dict['visuals'], exist_ok=True)
    os.makedirs(panop_eval_folder_dict['visuals_semantic'], exist_ok=True)
    os.makedirs(panop_eval_folder_dict['visuals_instance'], exist_ok=True)
    os.makedirs(panop_eval_folder_dict['visuals_amodal_instance'], exist_ok=True)
    os.makedirs(panop_eval_folder_dict['visuals_panoptic'], exist_ok=True)
    os.makedirs(panop_eval_folder_dict['visuals_amodal_panoptic'], exist_ok=True)
